var peopleToInvite = ["Habib", "Saad", "Taimoor", "Zeeshan", "Ammar"];
...
console.log(peopleToInvite[4] + " agar zindagi main kuch bara karna chahta hai to raat 9 bajy aaja mere ghar");
